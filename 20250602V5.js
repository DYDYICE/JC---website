document.addEventListener("DOMContentLoaded", function () {
  ...
  const titles = {
    "attractie": taal === "fr" ? "Nos attractions" : "Onze attracties",
    "aire de jeux": taal === "fr" ? "Aires de jeux" : "Speelzones",
    "jeux payants": taal === "fr" ? "Jeux payants" : "Betaalde spellen",
    "horeca": taal === "fr" ? "Restauration" : "Horeca",
    "animation": taal === "fr" ? "Animations" : "Animatie",
    "retail": taal === "fr" ? "Boutiques" : "Winkels"
  };

  document.getElementById("attracties-anchor").textContent = titles["attractie"];
  document.getElementById("section-aires").textContent = titles["aire de jeux"];
  document.getElementById("section-jeux").textContent = titles["jeux payants"];
  document.getElementById("section-horeca").textContent = titles["horeca"];
  document.getElementById("section-animation").textContent = titles["animation"];
  document.getElementById("section-retail").textContent = titles["retail"];
  ...
  function renderCards() {
    ...
    document.querySelectorAll(".attractions-grid").forEach(e => e.innerHTML = "");
    ...
    attracties.forEach(([id, name, type, conditions]) => {
      ...
      document.getElementById(`jc-${type.replace(/\s/g, "-")}`).appendChild(card);
    });
  }

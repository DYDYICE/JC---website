document.addEventListener("DOMContentLoaded", function () {
  ...
  if (path.includes("/fr/") && fr) {
    fr.innerHTML = `
      <h3><strong>🥚 À la chasse à l’Œuf d’Or – Pâques à Jungle City ! 🌴</strong></h3>
    ...
    `;
  } else if (path.includes("/nl/") && nl) {
    nl.innerHTML = `
      <h3><strong>🥚 Op zoek naar het Gouden Ei – Pasen bij Jungle City! 🌴</strong></h3>
